...
<div class="min-h-screen flex items-center justify-center p-4 pt-2 pb-8">
				...
				{#if !$authLoading}
					{#if $user}
						...
						<div class="relative group">
							...
							<!-- User Dropdown Menu -->
							<div class="absolute top-12 left-0 w-48 bg-white/95 backdrop-blur-lg rounded-xl shadow-xl border border-white/30 py-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none group-hover:pointer-events-auto z-10">
			...
			<div class="px-6 pt-3 pb-6 space-y-6">
				...
				<div class="flex flex-col space-y-4">
					...
					<div class="flex justify-between items-center">
						...
						{#if onboardingStep < onboardingSteps.length}
							<button 
								class="px-6 py-2 bg-primary-orange text-white rounded-lg font-medium hover:bg-orange-600 transition-all duration-200 flex items-center gap-2 group"
								on:click={nextStep}
							>
								Next
